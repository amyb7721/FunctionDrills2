...
const last = (arr, Callback) => Callback(arr[7])
...
// const uniq = (names, uniqArr) => Callback(`The new names array with all the duplicate items removed is ${uniqArr}.`))
...
const each = (name, Callback) => arr.forEach((el, i) => Callback(el, i)) 
  each(name, index[0]) 
